...
<a href={href} rel="noreferrer" class="py-3 md:py-0 animate-in fade-in-0 slide-in-from-left-1 duration-1000 delay-75 ease-in-out relative w-full group select-none" target="_blank">
